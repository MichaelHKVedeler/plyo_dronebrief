...
| Circle rig | Add at the current view center, drag center icon only, combined scale/rotation edge dot and oval handle, numbered inward arrows with saved count (default 10), live circle radius spinner and side-by-side oval radius spinners | Optional snapping and undo history |
