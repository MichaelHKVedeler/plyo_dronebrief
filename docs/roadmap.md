...
| Public briefing | No-sign-in Google Maps briefing from Export → Create Link: cameras and circle-rig icons at the editor Overlay size, floorplan, layer toggles, shoot times, capture instructions and reference images; no search, ShadeMap, overlay size control or map dimming | Production access/rules and public-link smoke tests |
