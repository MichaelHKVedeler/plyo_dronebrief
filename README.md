...
- Contents → Reference images holds up to four JPG/PNG photos with captions. They are stored with the brief, uploaded with cloud floorplans, and included automatically in PDF export and the public briefing sidebar.
