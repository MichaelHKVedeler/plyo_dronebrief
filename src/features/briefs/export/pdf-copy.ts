...
export const pdfCopy = {
  en: {
    ...
    heights: 'Heights', ground: 'Ground-level', perPoint: 'Heights set per point', photos: 'photos', time: 'time slot', times: 'time slots', perTime: 'per time slot',
  ...
  nb: {
    ...
    heights: 'Høyder', ground: 'Bakkenivå', perPoint: 'Høyder satt per punkt', photos: 'foto', time: 'tidspunkt', times: 'tidspunkt', perTime: 'per tidspunkt',
